        ...
        <div className="pt-[90px] ml-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 w-[calc(100%-90px)] pr-3 max-w-[1800px] 2xl:mx-auto">
          ...
          <div className="flex items-center pt-4">
            <div className="mr-4">
              ...
              <span className="text-gray-500 font-light text-[15px] pl-1.5">关注</span>
            </div>
            <div className="mr-4">
              <span className="font-bold">44K</span>
              <span className="text-gray-500 font-light text-[15px] pl-1.5">粉丝</span>
            </div>
          </div>
          ...
          <ul className="w-full flex items-center pt-4 border-b">
            <li className="w-60 text-center py-2 text-[17px] font-semibold border-b-2 border-b-black">视频</li>
            <li className="w-60 text-gray-500 text-center py-2 text-[17px] font-semibold">喜欢</li>
          </ul>

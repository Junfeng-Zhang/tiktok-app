            ...
            {!uploadedImage ? (
                  ...
                  <div className="flex items-center justify-center sm:-mt-6">
                    <div className="sm:w-[60%] w-full max-w-md">
                      ...
                      <p className={`relative text-[11px] text-gray-500 ${error ? 'mt-1' : 'mt-4'}`}>
                        用户名只能包含字母、数字、下划线和句点。更改您的用户名也会更改您的个人资料链接。
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-center sm:-mt-6">
                    <div className="sm:w-[60%] w-full max-w-md">
                      <textarea
                        ...
                        border-gray-300 rounded-md py-2.5 px-3focus:outline-none"
                      ></textarea>
              ...
              <div className="w-full max-h-[420px] mx-auto bg-black circle-stencil">
                <Cropper
                  ...
                  className="h-[400px]"
                  onChange={(cropper) => setCropper(cropper.getCoordinates())} // 得研究一下
                  src={uploadedImage}
                />
              </div>
            )}
          ...
          >
            {!uploadedImage ? (
              <div id="UpdateInfoButtons" className="flex items-center justify-end">
                ...
                >
                  <span className="px-2 font-medium text-[15px]">取消</span>
                </button>
                ...
                >
                  <span className="mx-4 font-medium text-[15px]">
                    {isUpdating ? <BiLoaderCircle color="#ffffff" className="my-1 mx-2.5 animate-spin" /> : "保存"}
                  </span>
                </button>
              ...
              <div id="CropperButtons" className="flex items-center justify-end" >
                ...
                >
                  <span className="mx-4 font-medium text-[15px]">
                    {isUpdating ? <BiLoaderCircle color="#ffffff" className="my-1 mx-2.5 animate-spin" /> : "应用"}
                  </span>
                </button>
